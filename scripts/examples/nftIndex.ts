...
const main = async function () {
    ...
    if (network === 'hardhat') {
        ...
        const egg: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['EGG'])) as ERC20
		const ave: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['AVE'])) as ERC20
		const klo: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['KLO'])) as ERC20

        console.log(await egg.balanceOf(beakerAddress))
		console.log(await ave.balanceOf(beakerAddress))
