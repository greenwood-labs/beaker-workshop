...
const main = async function () {
	...
	// const token1: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['CRA'])) as ERC20
	// const token2: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['TUS'])) as ERC20
	// const token3: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['CRAFT'])) as ERC20
