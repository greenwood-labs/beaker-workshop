...
const main = async function () {
	...
	const TOKEN_NAME = hre.ethers.utils.formatBytes32String("Low Cap Index")
    ...
    if (network === 'hardhat') {
        ...
        const qi: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['QI'])) as ERC20
		const png: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['PNG'])) as ERC20
		const pefi: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['PEFI'])) as ERC20
        const joe: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['JOE'])) as ERC20
        const klo: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['KLO'])) as ERC20
        const blzz: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['BLZZ'])) as ERC20
        ...
        const spore: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['SPORE'])) as ERC20
        const bag: ERC20 = (await hre.ethers.getContractAt(ERC20ABI, TOKENS['BAG'])) as ERC20

        console.log(await qi.balanceOf(beakerAddress))
		console.log(await png.balanceOf(beakerAddress))
		console.log(await pefi.balanceOf(beakerAddress))
        console.log(await joe.balanceOf(beakerAddress))
        console.log(await klo.balanceOf(beakerAddress))
        console.log(await blzz.balanceOf(beakerAddress))
        console.log(await cra.balanceOf(beakerAddress))
        console.log(await tus.balanceOf(beakerAddress))
        console.log(await spore.balanceOf(beakerAddress))
        console.log(await bag.balanceOf(beakerAddress))
    }
}
